...
export default function AdminLayout() {
  ...
  return (
    <div className="min-h-screen md:h-screen w-full overflow-hidden grid grid-cols-1 md:grid-cols-[260px_1fr] bg-white">
      <aside className={`${navOpen ? 'translate-x-0' : '-translate-x-full'} fixed md:static inset-y-0 left-0 w-64 md:w-auto transform md:translate-x-0 transition-transform duration-200 z-20 bg-orange-500 text-white p-4 flex md:flex-col items-center md:items-stretch gap-2 md:h-full overflow-y-auto`}>
